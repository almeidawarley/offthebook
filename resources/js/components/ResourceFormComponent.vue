    ...
    <div>
        ...
        <div v-for="(r,i) in registers" class="row align-center">
            ...
            <div class="input-field col s12 m3">
                ...
                <a class="waves-effect waves-light btn red" @click="registers.splice(i, 1)"><i class="material-icons ">remove</i></a>
            </div>
        </div>
        <input name="resources" v-model="registers.length" hidden/>
        <div class = "row center-align">
            <a class="waves-effect waves-light btn" @click="registers.push({'id': -1, 'path' : '', 'description' : '', 'new': true})">
